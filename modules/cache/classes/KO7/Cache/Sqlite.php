 ...
 */
class KO7_Cache_Sqlite extends Cache implements Cache_Tagging, Cache_GarbageCollect {
	...
	protected function __construct(array $config)
	{
		...
		if ($database === NULL)
		{
			throw new Cache_Exception('Database path not available in KO7 Cache configuration');
		}
		...
		if (0 == count($result))
		{
			...
			{
				throw new Cache_Exception('Database schema not found in KO7 Cache configuration');
			}
